...
//**************************捕获2发生捕获事件**************************			
    ...
    TIM_ClearITPendingBit(TIM2, TIM_IT_CC2 |	TIM_IT_Update ); 			 							//清除通道2中断标志位	
	}			 	
...
//**************************捕获3发生捕获事件**************************			
    ...
    TIM_ClearITPendingBit(TIM2, TIM_IT_CC3 |	TIM_IT_Update ); 			 							//清除通道3中断标志位	
	}			 
...
//**************************捕获4发生捕获事件**************************	
    ...
    TIM_ClearITPendingBit(TIM2, TIM_IT_CC4 |	TIM_IT_Update ); 			     					//清除通道4中断标志位	
	}			 
}
...
//**************************捕获2发生捕获事件**************************			
    ...
    TIM_ClearITPendingBit(TIM3, TIM_IT_CC2 |	TIM_IT_Update ); 			 							//清除通道2中断标志位	
	}		
}
